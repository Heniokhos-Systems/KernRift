...
|---|---|---|
| Linux x86_64 | 🔵 CI-verified | Self-compiles to a bootstrap fixed point; the full **1609-test** suite passes. This is the primary development target. |
...
|----------|---------|-----|-----------|----------|-------------------|
| Linux x86_64 | ✅ | ✅ | ✅ | ✅ | CI, native runner; bootstrap fixed point + full 1609-test suite |
